...
function GetDesire()
	...
	local objectiveDesire = Objectives.CollectionDesire(bot)
	if objectiveDesire > 0 then return objectiveDesire end
...
function OnEnd()
	Bottle = nil
	if bot.ohaCollection then bot.ohaCollection.arrived = nil end
...
function Think()
	...
	if bot.ohaCollection then
		Objectives.CollectionThink(bot)
		return
	end
